...
as [Quarto](https://quarto.org/) fragments.
It renders on its own as a website,
and course sites include it as a git submodule.

## Using these notes in another site

Add this repository as a git submodule named `sds` at the root of the host site,
